...
public class MyFirstController {
	...
	"<body>\n" + 
	"<table> <tr> <th> Ime </th> <th> Prezime </th></tr>" +
	"<tr><td> M </td> <td> S </td></tr><tr>" +
	"<tr><td> D </td> <td> B </td> </tr> <tr>" +
	"<tr><td> Lj </td> <td> C </td> </tr> <tr>" +
	"<tr><td> A </td> <td> M </td> </tr> </table>" +
	"</body>\n" + "</html>";
	}
	...
	public Map<String, String> getDict(){
		...
		dict.put("alas","avaj");
		dict.put("bubble","mehur");
		dict.put("cat","mačka");
		dict.put("danger","opasnost");
		dict.put("effervescence","živahnost");
		dict.put("evanescence","iščezavanje");
